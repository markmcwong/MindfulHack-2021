...
const SleepExercise1 = ({ navigation, route }) => {
  ...
  const carouselItems = [
    {
      title: "Create a Sleep-Inducing Bedroom",
      image: (
        <Image
          resizeMode="contain"
