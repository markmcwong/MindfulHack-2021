...
const MoodExercise2 = ({ navigation, route }) => {
  ...
  const carouselItems = [
    {
      ...
      image: (
        <Image
          ...
          alt="1"
          source={require("../assets/images/mindfulhack_MoodExercise_1.png")}
        />
      ),
    },
    {
      ...
      image: (
        <Image
          ...
          style={styles.carouselImage}
          alt="2"
          source={require("../assets/images/mindfulhack_MoodExercise_2.png")}
        />
      ),
    },
    {
      ...
      image: (
        <Image
          ...
          style={styles.carouselImage}
          alt="3"
          source={require("../assets/images/mindfulhack_MoodExercise_3.png")}
        />
      ),
    },
    {
